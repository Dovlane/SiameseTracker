...
"""
-metrike moze center error- broj 4 , 
-model koji je bolji od inicijalnog fully connected sloj zameni onim sto treba za nasu mrezu
resnet, mobilenet, inception torchvision tutorial odseci sve fullly connected slojeve - borj 6
-cuvanje modela-broj 2
-grafici, kako se kroz epohe ponasao model, kako je padao trening, kako je padao validacioni loss- broj 3
-treninig, validacija,test - broj 1
-vizualizacija,  kako je izgledao tracking pre a kako posle  - broj 5
